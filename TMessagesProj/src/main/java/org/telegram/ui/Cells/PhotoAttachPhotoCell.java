...
public class PhotoAttachPhotoCell extends FrameLayout {
    ...
    public PhotoAttachPhotoCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (Theme.isCurrentThemeMonet()) imageView1.setColorFilter(new PorterDuffColorFilter(Theme.getColor(Theme.key_chat_mediaTimeText), PorterDuff.Mode.MULTIPLY));
        ...
        videoTextView.setTextColor(Theme.isCurrentThemeMonet() ? Theme.getColor(Theme.key_chat_mediaTimeText) : 0xffffffff);
