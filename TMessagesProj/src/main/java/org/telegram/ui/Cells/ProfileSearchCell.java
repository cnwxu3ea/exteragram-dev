...
public class ProfileSearchCell extends BaseCell implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void buildLayout() {
        ...
        if (encryptedChat != null) {
            ...
            updateStatus(false, false, null, null, false);
        } else if (chat != null) {
            dialog_id = -chat.id;
            ...
            updateStatus(drawCheck, false, null, chat, false);
        } else if (user != null) {
            dialog_id = user.id;
            if (!LocaleController.isRTL) {
                nameLeft = AndroidUtilities.dp(AndroidUtilities.leftBaseline);
            ...
            updateStatus(drawCheck, false, user, null, false);
    ...
    public void updateStatus(boolean verified, boolean arrow, TLRPC.User user, TLRPC.Chat chat, boolean animated) {
    ...
    public void update(int mask) {
        ...
        avatarImage.setRoundRadius(ExteraConfig.getAvatarCorners(46, false, chat != null && chat.forum));
        if (mask != 0) {
